export function modalEditStone(_dataStone) {
    ...
    <aside id="edit_stone">
        ...
        <input class="modal_input" type="text" id="stone_name" name="stone_name" placeholder="Nome"/>
        <input class="modal_input" type="number" id="stone_weight" name="stone_weight" placeholder="Description..."/>
