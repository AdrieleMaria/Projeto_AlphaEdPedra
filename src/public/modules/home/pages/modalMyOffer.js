export function minhasOfertasModal(_data) {
    ...
    <div id="inventory_modal">
        <div>
        <button id="closeCreate" onclick="exchanges(3)">
        ...
        <div>
            ...
            <img width="100%" height="100%" src="${_data.user_img_url}" />
        ...
        <div>
            ...
            <img width="100%" height="100%" src="${_data.trocador_stone_url}" />

            <div>
                <p id="stone_name">Trocar por: ${_data.trocador_stone_name}</p>
                <p id="stone_name">Entre em contato com: ${_data.trocador_name}</p>
                <p id="stone_name">Telefone: ${_data.trocador_phone}</p>
                <p id="stone_name">Email: ${_data.trocador_email}</p>
            </div>  
